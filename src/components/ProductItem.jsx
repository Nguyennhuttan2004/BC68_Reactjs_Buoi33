    ...
    <div className="item border">
      ...
      <div className="px-4 py-4 text-sm">
        ...
        <div className="flex items-center justify-between text-sm">
          <button className="bg-black text-white rounded-md py-2 px-5 cart-btn">
            Add to cart <ShoppingCartOutlined />
          </button>
          <button onClick={showModal} className="bg-black rounded-md text-white py-2 px-5 cart-btn">
            View detail
          </button>
          <Modal
            open={isModalOpen}
